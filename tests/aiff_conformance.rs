...
//! 4. channel count: 1, 2, and more than 2
...
/// The cross product: thirteen encoding rows, three channel counts, four
/// lengths, eight chunk layouts and four `SSND` shapes (4,992 files) with
